...
class Customer(Base):
    ...
    def __init__(self, id: int, name: str, created_at: str | None = None, updated_at: str | None = None, deleted_at: str | None = None):
...
class Job(Base):
    ...
    def __init__(self, id: int, name: str, description: str, 
                 created_at: str | None = None, updated_at: str | None = None, deleted_at: str | None = None,
...
class Revision(Base):
    ...
    def __init__(self, id: int, version: str, description: str, file_path: str,
                 created_at: str | None = None, updated_at: str | None = None, deleted_at: str | None = None,
